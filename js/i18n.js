...
const I18N_BUNDLE = {
  en: {
    ...
    ctrl_lighting:'Lighting', ctrl_mesh_opacity:'Mesh', btn_normals:'Smoothing', btn_grid:'Grid', btn_walkmesh:'Walkmesh', btn_pwk:'PWK', btn_dwk:'DWK',
    wok_pin_title: 'Fix WOK when loading next model', pwk_pin_title: 'Fix PWK when loading next model',
    wok_pinned_on: 'Walkmesh fixed — persists when loading new models.', pwk_pinned_on: 'PWK is fixed — remains preserved when loading new models.',
    ...
    btn_bbox:'BBox', btn_axes:'Axes', btn_rotate:'Rotate', btn_resetcam:'↺ Cam', btn_skeleton:'Skeleton', btn_floor:'Floor',
    ...
    dcmp_phase_fetch:              'Downloading WASM… {pct}%',
    dcmp_phase_fetch_indeterminate:'Downloading WASM…',
    dcmp_phase_decode:             'Decoding…',
    dcmp_phase_compile:            'Compiling WASM…',
    dcmp_phase_instantiate:        'Instantiating…',
    dcmp_phase_wait:               'Starting up…',
    dcmp_phase_ready:              'Ready',
    dcmp_phase_decompile:          'Decompiling…',
    ...
    // Set Browser
    btn_set_browser:      '🗃 Set Browser',
    sb_panel_title:       'Set Browser',
    sb_load_btn:          '📂 Load .set',
    sb_filter_ph:         'Filter tile / model…',
    sb_group_all:         'All Groups',
    sb_tile_count:        '{n} Tiles',
    sb_no_set:            'No .set file loaded',
    sb_loaded:            'Set loaded: {name} ({n} tiles)',
    sb_tile_loaded:       'Tile #{nr} loaded: {model}',
    sb_tile_changed:      'File changed on disk — click tile to reload ({model})',
    sb_tile_unavail:      'MDL not in watch folder',
    sb_tile_available:    '#{nr} {model} — click to load',
    sb_tile_active_tip:   'Loaded: #{nr} {model}',
  ...
  de: {
    ...
    ctrl_lighting:'Beleuchtung', ctrl_mesh_opacity:'Mesh', btn_normals:'Glätten', btn_grid:'Raster', btn_walkmesh:'Walkmesh', btn_pwk:'PWK', btn_dwk:'DWK',
    wok_pin_title: 'WOK beim nächsten Modell-Laden fixieren', pwk_pin_title: 'PWK beim nächsten Modell-Laden fixieren',
    wok_pinned_on: 'Walkmesh ist fixiert — bleibt beim Laden neuer Modelle erhalten', pwk_pinned_on: 'PWK ist fixiert — bleibt beim Laden neuer Modelle erhalten',
    dwk_state_closed:'Geschlossen', dwk_state_open1:'Auf 1', dwk_state_open2:'Auf 2',
    ...
    btn_bbox:'BBox', btn_axes:'Achsen', btn_rotate:'Rotation', btn_resetcam:'↺Kam', btn_skeleton:'Skelett', btn_floor:'Boden',
    ...
    dcmp_phase_fetch:              'Lade WASM… {pct}%',
    dcmp_phase_fetch_indeterminate:'Lade WASM…',
    dcmp_phase_decode:             'Dekodiere…',
    dcmp_phase_compile:            'Kompiliere WASM…',
    dcmp_phase_instantiate:        'Initialisiere…',
    dcmp_phase_wait:               'Starte…',
    dcmp_phase_ready:              'Bereit',
    dcmp_phase_decompile:          'Dekompiliere…',
    ...
    btn_set_browser:      '🗃 Set Browser',
    sb_panel_title:       'Set Browser',
    sb_load_btn:          '📂 .set laden',
    sb_filter_ph:         'Tile / Modell filtern…',
    sb_group_all:         'Alle Gruppen',
    sb_tile_count:        '{n} Tiles',
    sb_no_set:            'Keine .set-Datei geladen',
    sb_loaded:            'Set geladen: {name} ({n} Tiles)',
    sb_tile_loaded:       'Tile #{nr} geladen: {model}',
    sb_tile_changed:      'Datei auf Disk geändert — Tile klicken zum Neuladen ({model})',
    sb_tile_unavail:      'MDL nicht im beobachteten Ordner',
    sb_tile_available:    '#{nr} {model} — klicken zum Laden',
    sb_tile_active_tip:   'Geladen: #{nr} {model}',
